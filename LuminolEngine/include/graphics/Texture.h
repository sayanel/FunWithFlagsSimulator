...
namespace Graphics
{
    ...
    struct TexParams{
        ...
        // TexParams(GLenum internalForm=GL_RGBA32F, GLenum form=GL_RGB, GLenum typ=GL_FLOAT, GLenum wrap=GL_CLAMP_TO_EDGE, GLenum filter=GL_LINEAR, bool mipm = true) :
        ...
        static TexParams rgbaFBO(){
            ...
            return TexParams(GL_RGBA32F,  GL_RGBA, GL_FLOAT, GL_CLAMP_TO_EDGE, GL_LINEAR, false);
        }

        static TexParams normalEncodedFBO(){
            // return TexParams(GL_RGB,  GL_RGB, GL_FLOAT, GL_CLAMP_TO_EDGE, GL_NEAREST, false);
            return TexParams(GL_RGBA32F,  GL_RGBA, GL_FLOAT, GL_CLAMP_TO_EDGE, GL_NEAREST, false);
        }

        static TexParams brightColorFBO(){
            return TexParams(GL_RGBA32F,  GL_RGBA, GL_FLOAT, GL_CLAMP_TO_EDGE, GL_LINEAR, false);
        }
